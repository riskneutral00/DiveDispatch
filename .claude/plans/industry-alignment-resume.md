# Resume Prompt — Industry Alignment

Paste this into a new Claude Code session opened from `~/Desktop/RiskNeutral/DiveDispatch`:
...
Your job is to continue with Phase 2 of the execution order in Industry-Alignment-Decisions.md. Start with Track A (FSM: seal the declineReservation bypass + add Archived terminal state — these are merged into one task). Then proceed through the other tracks.

Before making any changes, read the relevant invariant file for the domain you're about to touch. The invariant files are law — your changes must comply with them.
