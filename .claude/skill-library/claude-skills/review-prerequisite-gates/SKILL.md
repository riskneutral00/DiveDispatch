...
↳ Vault: review written to Reviews/review-prerequisite-gates-{date}.md, findings escalated
```
...
- **CRITICAL and HIGH get tickets via /escalate + tests. MEDIUM and LOW get logged to .backseat/findings.md.**
