...
1. Read `Architecture/auth-model.md` — the canonical auth rules. Every finding must be evaluated against these invariants.
...
10. Find most recent vault review: `ls ~/Desktop/RiskNeutral/Vaults/DiveDispatch/raw/Reviews/review-backend-auth-*.md | sort | tail -1`
...
Write to `~/Desktop/RiskNeutral/Vaults/DiveDispatch/raw/Reviews/review-backend-auth-YYYY-MM-DD.md`:
