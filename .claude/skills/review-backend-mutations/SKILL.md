...
10. Find most recent vault review: `ls ~/Desktop/DiveVault/DiveDispatch/Reviews/review-backend-mutations-*.md | sort | tail -1`
...
Write to `~/Desktop/DiveVault/DiveDispatch/Reviews/review-backend-mutations-YYYY-MM-DD.md`:
