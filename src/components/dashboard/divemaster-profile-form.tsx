    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-6">
      ...
      {(!section || section === 'languages') && (
        <GlassCard padding="md">
          ...
          <CheckboxGroup label="Languages you guide in" items={langItems} selected={form.languages} onChange={(values) => setField('languages', values)} error={errors.languages} columns={3} />
        </GlassCard>
      )}
