...
export const ALL_INSTRUCTORS: SeedStakeholder[] = [PIERRE_DUBOIS, STEFAN_BRAUN, NATTAYA_SRISUK, ZHANG_YONG, SATO_KENJI, PRASIT_RATTANA, MIKE_CHEN, LEE_MIN_HO, MARIA_SANTOS, HIROSHI_KATO]
