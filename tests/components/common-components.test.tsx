...
describe('FormSectionHeader', () => {
  it('renders label as heading', async () => {
    const { FormSectionHeader } = await import('@/components/ui/form-section-header')
...
describe('PillToggle', () => {
  it('renders checkbox with label', async () => {
    const { PillToggle } = await import('@/components/ui/pill-toggle')
...
describe('PillToggleGroup', () => {
  it('renders children and shows More button when overflow provided', async () => {
    const { PillToggleGroup, PillToggle } = await import('@/components/ui/pill-toggle')
    render(
